...
**読み方**：3つのエンジンは別チャネルですが、**同じ辞書を引きます**。これが再現性の源泉です（→ [methodology.md §8](docs/methodology.md#8-再現性について)）。
...
| CONTRIBUTING | ✅ [CONTRIBUTING.md](CONTRIBUTING.md) + Issue templates 5種（atom / pattern / challenge / bug / question） |
| Web UI | ⏳ 将来 |
